...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 178, ; uint32_t number_of_assemblies_in_apk (0xb2)
	i32 64, ; uint32_t bundled_assembly_name_width (0x40)
...
@dso_cache = dso_local local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2322275637231457051, ; hash 0x203a61635bb9931b, from name: libSystem.IO.Ports.Native
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libSystem.IO.Ports.Native.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6651103358894670200, ; hash 0x5c4d77440f530178, from name: System.IO.Ports.Native
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libSystem.IO.Ports.Native.so
		ptr null; void* handle (0x0)
	}, ; 12
	...
	%struct.DSOCacheEntry {
		i64 9645564184571171892, ; hash 0x85dbed857f985434, from name: libSystem.IO.Ports.Native.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libSystem.IO.Ports.Native.so
		ptr null; void* handle (0x0)
	}, ; 23
	...
	%struct.DSOCacheEntry {
		i64 10484487816872484105, ; hash 0x9180621ec8985d09, from name: System.IO.Ports.Native.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libSystem.IO.Ports.Native.so
		ptr null; void* handle (0x0)
	}, ; 25
...
@bundled_assemblies = dso_local local_unnamed_addr global [178 x %struct.XamarinAndroidBundledAssembly] [
	%struct.XamarinAndroidBundledAssembly {
		...
		i32 64, ; uint32_t name_length (0x40)
...
@.env.7 = private unnamed_addr constant [37 x i8] c"6b5cbe14-3e16-49d7-8073-66f059f0df43\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.example.shimmerbridge.cs\00", align 1
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [29 x i8] c"libSystem.IO.Ports.Native.so\00", align 1
